                ...
                <div class="row">
                    <fieldset class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label for="inpId">Prontuário * </label>
                        ...
                        <div class="form-group">
                            <label for="inpNomePai">Nome do Pai * </label>
                            <input id="inpNomePai" class="form-control" type="text"
                                   name="nome" placeholder="Ex.: João da Silva"
                                   required >
                        </div>

                        <div class="form-group">
                            <label for="inpNomeMae">Nome da Mãe * </label>
                            <input id="inpNomeMae" class="form-control" type="text"
                                   name="nome" placeholder="Ex.: Maria da Silva"
                                   required >
                        </div>
                        
                        <!-- FICAR DE AJUSTAR -->
                        <div class="form-group">
                            <label>Tipo Sânguineo * </label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tiposanguineo" id="radioSangA" value="a">
                                <label class="form-check-label" for="radioSangA">
                                    A
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tiposanguineo" id="radioSangB" value="b">
                                <label class="form-check-label" for="radioSangA">
                                    B
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tiposanguineo" id="radioSangAB" value="ab">
                                <label class="form-check-label" for="radioSangAB">
                                    AB
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tiposanguineo" id="radioSangO" value="o">
                                <label class="form-check-label" for="radioSangO">
                                    B
                                </label>
                            </div>
                        </div>
